...
<head>
    ...
    <meta name="author" content="HUN SOREYA">
    <meta name="keywords" content="au theme template">


    <!-- Fontfaces CSS-->
    <link href="{{ URL::asset('css/font-face.css') }}" rel="stylesheet" media="all" type="text/css" >
...
@include('partial.navbaradmin.header');
<!-- Jquery JS-->
...
<script src="{{ URL::asset('vendor/counter-up/jquery.counterup.min.j')}}s">
</script>
